...
class getid3_quicktime extends getid3_handler
{
	...
	public function QuicktimeParseAtom($atomname, $atomsize, $atom_data, $baseoffset, &$atomHierarchy, $ParseAllPossibleAtoms) {
		// //developer.apple.com/techpubs/quicktime/qtdevdocs/APIREF/INDEX/atomalphaindex.htm
		...
		if (substr($atomname, 0, 3) == "\x00\x00\x00") {
			...
			switch ($atomname) {
				...
				case 'ptv ': // Print To Video - defines a movie's full screen mode
					// //developer.apple.com/documentation/QuickTime/APIREF/SOURCESIV/at_ptv-_pg.htm
...
$this->warning('incomplete/incorrect handling of "stsd" with Parrot metadata in this version of getID3() ['.$this->getid3->version().']');
						...
						switch ($atom_structure['sample_description_table'][$i]['encoder_vendor']) {
							...
							case "\x00\x00\x00\x00":
								...
								// video tracks
								// //developer.apple.com/library/mac/#documentation/QuickTime/QTFF/QTFFChap3/qtff3.html
...
//					if (true) {
				...
				case 'tkhd': // TracK HeaDer atom
					...
					// //developer.apple.com/library/mac/#documentation/QuickTime/RM/MovieBasics/MTEditing/K-Chapter/11MatrixFunctions.html
					// //developer.apple.com/library/mac/#documentation/QuickTime/qtff/QTFFChap4/qtff4.html#//apple_ref/doc/uid/TP40000939-CH206-18737
				...
				case 'iods': // Initial Object DeScriptor atom
					// //www.koders.com/c/fid1FAB3E762903DC482D8A246D4A4BF9F28E049594.aspx?s=windows.h
					// //libquicktime.sourcearchive.com/documentation/1.0.2plus-pdebian/iods_8c-source.html
					$offset = 0;
	...
	/* due to lack of known documentation, this is a kludge implementation. If you know of documentation on how mdat is properly structed, please send it to info@getid3.org */
				...
				case 'nsav': // NoSAVe atom
					// //developer.apple.com/technotes/tn/tn2038.html
				...
				case 'PrmA':
				case 'code':
				case 'FIEL': // this is NOT "fiel" (Field Ordering) as describe here: //developer.apple.com/documentation/QuickTime/QTFF/QTFFChap3/chapter_4_section_2.html
				case 'tapt': // TrackApertureModeDimensionsAID - //developer.apple.com/documentation/QuickTime/Reference/QT7-1_Update_Reference/Constants/Constants.html
							// tapt seems to be used to compute the video size [https://www.getid3.org/phpBB3/viewtopic.php?t=838]
							// * //lists.apple.com/archives/quicktime-api/2006/Aug/msg00014.html
							// * //handbrake.fr/irclogs/handbrake-dev/handbrake-dev20080128_pg2.html
				case 'ctts'://  STCompositionOffsetAID             - //developer.apple.com/documentation/QuickTime/Reference/QTRef_Constants/Reference/reference.html
				case 'cslg'://  STCompositionShiftLeastGreatestAID - //developer.apple.com/documentation/QuickTime/Reference/QTRef_Constants/Reference/reference.html
				case 'sdtp'://  STSampleDependencyAID              - //developer.apple.com/documentation/QuickTime/Reference/QTRef_Constants/Reference/reference.html
				case 'stps'://  STPartialSyncSampleAID             - //developer.apple.com/documentation/QuickTime/Reference/QTRef_Constants/Reference/reference.html
					//$atom_structure['data'] = $atom_data;
					break;
				...
				case 'NCVW': // Nikon Camera preVieW image
					...
					break;
				case 'NCTG': // Nikon - //www.sno.phy.queensu.ca/~phil/exiftool/TagNames/Nikon.html#NCTG
					$atom_structure['data'] = $this->QuicktimeParseNikonNCTG($atom_data);
					break;
				case 'NCHD': // Nikon:MakerNoteVersion  - //www.sno.phy.queensu.ca/~phil/exiftool/TagNames/Nikon.html
				case 'NCDB': // Nikon                   - //www.sno.phy.queensu.ca/~phil/exiftool/TagNames/Nikon.html
				case 'CNCV': // Canon:CompressorVersion - //www.sno.phy.queensu.ca/~phil/exiftool/TagNames/Canon.html
					$atom_structure['data'] = $atom_data;
					break;
				...
				case 'uuid': // user-defined atom often seen containing XML data, also used for potentially many other purposes, only a few specifically handled by getID3 (e.g. 360fly spatial data)
					...
					switch ($atom_structure['uuid_field_id']) {   // //fileformats.archiveteam.org/wiki/Boxes/atoms_format#UUID_boxes

						case '0537cdab-9d0c-4431-a72a-fa561f2a113e': // Exif                                       - //fileformats.archiveteam.org/wiki/Exif
						case '2c4c0100-8504-40b9-a03e-562148d6dfeb': // Photoshop Image Resources                  - //fileformats.archiveteam.org/wiki/Photoshop_Image_Resources
						case '33c7a4d2-b81d-4723-a0ba-f1a3e097ad38': // IPTC-IIM                                   - //fileformats.archiveteam.org/wiki/IPTC-IIM
						case '8974dbce-7be7-4c51-84f9-7148f9882554': // PIFF Track Encryption Box                  - //fileformats.archiveteam.org/wiki/Protected_Interoperable_File_Format
						case '96a9f1f1-dc98-402d-a7ae-d68e34451809': // GeoJP2 World File Box                      - //fileformats.archiveteam.org/wiki/GeoJP2
						case 'a2394f52-5a9b-4f14-a244-6c427c648df4': // PIFF Sample Encryption Box                 - //fileformats.archiveteam.org/wiki/Protected_Interoperable_File_Format
						case 'b14bf8bd-083d-4b43-a5ae-8cd7d5a6ce03': // GeoJP2 GeoTIFF Box                         - //fileformats.archiveteam.org/wiki/GeoJP2
						case 'd08a4f18-10f3-4a82-b6c8-32d8aba183d3': // PIFF Protection System Specific Header Box - //fileformats.archiveteam.org/wiki/Protected_Interoperable_File_Format
	...
	public function quicktime_read_mp4_descr_length($data, &$offset) {
		// //libquicktime.sourcearchive.com/documentation/2:1.0.2plus-pdebian-2build1/esds_8c-source.html
		$num_bytes = 0;
		$length    = 0;
		do {
	...
	public function QuicktimeLanguageLookup($languageid) {
		// //developer.apple.com/library/mac/#documentation/QuickTime/QTFF/QTFFChap4/qtff4.html#//apple_ref/doc/uid/TP40000939-CH206-34353
		...
		if (($languageid > 138) && ($languageid < 32767)) {
			/*
			ISO Language Codes - //www.loc.gov/standards/iso639-2/php/code_list.php
	...
	public function QuicktimeParseNikonNCTG($atom_data) {
		// //www.sno.phy.queensu.ca/~phil/exiftool/TagNames/Nikon.html#NCTG
		// Nikon-specific QuickTime tags found in the NCDT atom of MOV videos from some Nikon cameras such as the Coolpix S8000 and D5100
		...
		while ($offset < $datalength) {
			...
			switch ($record_type) {
				...
				case 0x02000024: // WorldTime
					// //www.sno.phy.queensu.ca/~phil/exiftool/TagNames/Nikon.html#WorldTime
	...
	public function CopyToAppropriateCommentsSection($keyname, $data, $boxname='') {
		...
		if (empty($handyatomtranslatorarray)) {
			...
			// //atomicparsley.sourceforge.net/mpeg-4files.html
			// https://code.google.com/p/mp4v2/wiki/iTunesMetadata
