...
class getid3_lib
{
	...
	/**
	 * @link //www.scri.fsu.edu/~jac/MAD3401/Backgrnd/binary.html
	 *
	...
	/**
	 * @link //www.scri.fsu.edu/~jac/MAD3401/Backgrnd/ieee-expl.html
	 *
	 * @param float $floatvalue
	 * @param int $bits
	 *
	 ...
	 *
	 * @link //www.psc.edu/general/software/packages/ieee/ieee.html
	 * @link //www.scri.fsu.edu/~jac/MAD3401/Backgrnd/ieee.html
	 *
	 * @param string $byteword
	 *
	 * @return float|false
	...
	public static function array_merge_clobber($array1, $array2) {
		...
		// taken from //www.php.net/manual/en/function.array-merge-recursive.php
	...
	public static function XML2array($XMLstring) {
		if (function_exists('simplexml_load_string') && function_exists('libxml_disable_entity_loader')) {
			// //websec.io/2012/08/27/Preventing-XEE-in-PHP.html
