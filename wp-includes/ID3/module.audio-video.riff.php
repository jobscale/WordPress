						...
						switch ($thisfile_riff_audio['codec_name']) {
							...
							case '':
								switch ($thisfile_riff_audio['codec_fourcc']) {
									// //developer.apple.com/qa/snd/snd07.html
									case 'sowt':
...
*/
	...
	public static function ParseDIVXTAG($DIVXTAG, $raw=false) {
		// structure from "IDivX" source, Form1.frm, by "Greg Frazier of Daemonic Software Group", email: gfrazier@icestorm.net, web: //dsg.cjb.net/
		// source available at //files.divx-digest.com/download/c663efe7ef8ad2e90bf4af4d3ea6188a/on0SWN2r/edit/IDivX.zip
	...
	public static function fourccLookup($fourcc) {
		...
		/** This is not a comment!
			...
			swot	//developer.apple.com/qa/snd/snd07.html
			____	No Codec (____)
			...
			RUD0	Rududu video codec (//rududu.ifrance.com/rududu/)
			...
			VIV2	Vivo H.263
			VQC2	Vector-quantised codec 2 (research) //eprints.ecs.soton.ac.uk/archive/00001310/01/VTC97-js.pdf)
